        ...
        {isSearchOpen ? (
          ...
          >
            ...
            <TextInput
              ...
              placeholder="Search profile, settings, locker..."
          ...
          >
            ...
            {/* Right: Search & Settings Buttons Pill */}
            <View style={styles.actionsPill}>
              ...
              <AnimatedPressable
                ...
                onPressIn={() => {
                  settingsBtnScale.value = withSpring(0.92, Motion.tactileSpring);
                }}
                onPressOut={() => {
                  settingsBtnScale.value = withSpring(1, Motion.tactileSpring);
                }}
                style={[styles.iconButton, settingsBtnAnimStyle]}
                accessibilityRole="button"
